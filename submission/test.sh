...
# WRITE YOUR SOLUTION BELOW:
TREASURE_ADDR=$(bitcoin-cli -regtest getnewaddress)
...
# WRITE YOUR SOLUTION BELOW:
LEGACY_ADDR=$(bitcoin-cli -regtest getnewaddress -addresstype legacy)
check_cmd "Legacy address generation"

P2SH_ADDR=$(bitcoin-cli -regtest getnewaddress -addresstype p2sh-segwit)
...
TAPROOT_ADDR=$(bitcoin-cli -regtest getnewaddress -addresstype bech32)
...
# WRITE YOUR SOLUTION BELOW:
NEW_BALANCE=$(bitcoin-cli -regtest getbalance)
