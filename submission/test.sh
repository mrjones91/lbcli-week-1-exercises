...
# WRITE YOUR SOLUTION BELOW:
TREASURE_ADDR=$(bitcoin-cli getnewaddress)
...
# WRITE YOUR SOLUTION BELOW:
LEGACY_ADDR=$(bitcoin-cli getnewaddress -addresstype legacy)
check_cmd "Legacy address generation"

P2SH_ADDR=$(bitcoin-cli getnewaddress -addresstype p2sh-segwit)
...
TAPROOT_ADDR=$(bitcoin-cli getnewaddress -addresstype bech32)
...
# WRITE YOUR SOLUTION BELOW:
NEW_BALANCE=$(bitcoin-cli getbalance)
...
# WRITE YOUR SOLUTION BELOW:
P2SH_VALID=$(bitcoin-cli validateaddress "$P2SH_ADDR")
